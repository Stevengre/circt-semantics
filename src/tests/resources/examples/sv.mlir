...
"builtin.module"() ({
  ...
  "hw.module.extern"() ({
  }) {parameters = [], port_locs = [#loc3, #loc4], sym_name = "ExternDestMod"} : () -> ()
  
  "hw.module"() ({
  ^bb0(%arg0: i1, %arg1: i2):
    "hw.output"() : () -> ()
  }) {parameters = [], port_locs = [#loc5, #loc6], sym_name = "InternalDestMod"} : () -> ()
  ...
  ^bb0(%arg0: i1, %arg1: i2):
    ...
    "hw.output"() : () -> ()
  }) {parameters = [], port_locs = [#loc7, #loc8], sym_name = "AB"} : () -> ()
  ...
  ^bb0(%arg0: i23):
    ...
    "hw.output"() : () -> ()
  }) {parameters = [], port_locs = [#loc9], sym_name = "XMR_src"} : () -> ()
  ...
  ^bb0(%arg0: i4, %arg1: i8):
    ...
    "hw.output"(%6, %8) : (i3, i5) -> ()
  }) {parameters = [], port_locs = [#loc10, #loc11, #loc12, #loc13], sym_name = "part_select"} : () -> ()
  ...
  ^bb0(%arg0: i1):
    ...
    "hw.output"() : () -> ()
  }) {parameters = [], port_locs = [#loc14], sym_name = "nested_wire"} : () -> ()
  ...
  ^bb0(%arg0: i1):
    ...
    "hw.output"() : () -> ()
  }) {parameters = [], port_locs = [#loc15], sym_name = "ordered_region"} : () -> ()
  
  "hw.hierpath"() {namepath = [#hw.innerNameRef<@XMRRefOp::@foo>, #hw.innerNameRef<@XMRRefFoo::@a>], sym_name = "ref", sym_visibility = "private"} : () -> ()
  
  "hw.hierpath"() {namepath = [#hw.innerNameRef<@XMRRefOp::@bar>], sym_name = "ref2"} : () -> ()
  
  "hw.module.extern"() ({
  }) {parameters = [], sym_name = "XMRRefBar"} : () -> ()

  "hw.module"() ({
    %0 = "sv.wire"() {inner_sym = #hw<innerSym@a>, name = "a"} : () -> !hw.inout<i2>
    "hw.output"() : () -> ()
  }) {parameters = [], sym_name = "XMRRefFoo"} : () -> ()
