...
VL_ATTR_COLD void Vxor___024root___eval_initial(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vxor___024root___dump_triggers__stl(Vxor___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vxor___024root___eval_phase__stl(Vxor___024root* vlSelf);
...
#ifdef VL_DEBUG
            Vxor___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("comb/xor/xor.sv", 2, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vxor___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vxor___024root___dump_triggers__stl(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___dump_triggers__stl\n"); );
    // Body
...
void Vxor___024root___ico_sequent__TOP__0(Vxor___024root* vlSelf);

VL_ATTR_COLD void Vxor___024root___eval_stl(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vxor___024root___ico_sequent__TOP__0(vlSelf);
    }
}

VL_ATTR_COLD void Vxor___024root___eval_triggers__stl(Vxor___024root* vlSelf);

VL_ATTR_COLD bool Vxor___024root___eval_phase__stl(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vxor___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vxor___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vxor___024root___dump_triggers__ico(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___dump_triggers__ico\n"); );
    // Body
