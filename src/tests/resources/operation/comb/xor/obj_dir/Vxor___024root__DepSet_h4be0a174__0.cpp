...
VL_INLINE_OPT void Vxor___024root___ico_sequent__TOP__0(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___ico_sequent__TOP__0\n"); );
    // Body
    vlSelf->res = ((IData)(vlSelf->a) ^ (IData)(vlSelf->b));
}

void Vxor___024root___eval_ico(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___eval_ico\n"); );
    // Body
...
bool Vxor___024root___eval_phase__ico(Vxor___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root___eval_phase__ico\n"); );
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vxor___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelf->__VicoTriggered.any();
    if (__VicoExecute) {
        Vxor___024root___eval_ico(vlSelf);
    }
...
#endif
            VL_FATAL_MT("comb/xor/xor.sv", 2, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vxor___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
...
#endif
            VL_FATAL_MT("comb/xor/xor.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("comb/xor/xor.sv", 2, "", "Active region did not converge.");
            }
