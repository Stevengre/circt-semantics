...
void Vxor___024root__trace_chg_0_sub_0(Vxor___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vxor___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vxor___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vxor___024root__trace_chg_0_sub_0(Vxor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vxor___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxor___024root__trace_cleanup\n"); );
    // Init
    Vxor___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vxor___024root*>(voidSelf);
    Vxor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
