...
VL_INLINE_OPT void Vand::_combo__TOP__1(Vand__Syms* __restrict vlSymsp) {
    ...
    Vand* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->res = ((IData)(vlTOPp->a) & (IData)(vlTOPp->b));
}
...
VL_INLINE_OPT QData Vand::_change_request_1(Vand__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand::_change_request_1\n"); );
    Vand* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
