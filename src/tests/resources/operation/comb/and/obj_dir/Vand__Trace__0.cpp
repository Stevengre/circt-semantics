...
void Vand___024root__trace_chg_0_sub_0(Vand___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vand___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vand___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vand___024root__trace_chg_0_sub_0(Vand___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vand__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vand___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand___024root__trace_cleanup\n"); );
    // Init
    Vand___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vand___024root*>(voidSelf);
    Vand__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
