...
void Vor___024root__trace_chg_0_sub_0(Vor___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vor___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vor___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vor___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vor___024root__trace_chg_0_sub_0(Vor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vor___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vor___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vor___024root__trace_cleanup\n"); );
    // Init
    Vor___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vor___024root*>(voidSelf);
    Vor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
