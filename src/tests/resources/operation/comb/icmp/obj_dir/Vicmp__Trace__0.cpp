...
void Vicmp___024root__trace_chg_0_sub_0(Vicmp___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vicmp___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicmp___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vicmp___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vicmp___024root__trace_chg_0_sub_0(Vicmp___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicmp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicmp___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vicmp___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicmp___024root__trace_cleanup\n"); );
    // Init
    Vicmp___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vicmp___024root*>(voidSelf);
    Vicmp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
