...
void Vshru___024root__trace_chg_0_sub_0(Vshru___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vshru___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshru___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vshru___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vshru___024root__trace_chg_0_sub_0(Vshru___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vshru__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshru___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vshru___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshru___024root__trace_cleanup\n"); );
    // Init
    Vshru___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vshru___024root*>(voidSelf);
    Vshru__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
