...
void Vdivu___024root__trace_chg_0_sub_0(Vdivu___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vdivu___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdivu___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vdivu___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vdivu___024root__trace_chg_0_sub_0(Vdivu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vdivu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdivu___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vdivu___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdivu___024root__trace_cleanup\n"); );
    // Init
    Vdivu___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vdivu___024root*>(voidSelf);
    Vdivu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
