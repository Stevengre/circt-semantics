...
void Varray_get___024root__trace_chg_0_sub_0(Varray_get___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Varray_get___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varray_get___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Varray_get___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Varray_get___024root__trace_chg_0_sub_0(Varray_get___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Varray_get__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varray_get___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Varray_get___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varray_get___024root__trace_cleanup\n"); );
    // Init
    Varray_get___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Varray_get___024root*>(voidSelf);
    Varray_get__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
