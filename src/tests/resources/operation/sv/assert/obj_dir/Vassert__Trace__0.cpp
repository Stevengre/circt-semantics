...
void Vassert___024root__trace_chg_0_sub_0(Vassert___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vassert___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vassert___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vassert___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vassert___024root__trace_chg_0_sub_0(Vassert___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vassert__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vassert___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vassert___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vassert___024root__trace_cleanup\n"); );
    // Init
    Vassert___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vassert___024root*>(voidSelf);
    Vassert__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
