...
void Vverbatim___024root__trace_chg_0_sub_0(Vverbatim___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vverbatim___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vverbatim___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vverbatim___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vverbatim___024root__trace_chg_0_sub_0(Vverbatim___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vverbatim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vverbatim___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vverbatim___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vverbatim___024root__trace_cleanup\n"); );
    // Init
    Vverbatim___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vverbatim___024root*>(voidSelf);
    Vverbatim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
