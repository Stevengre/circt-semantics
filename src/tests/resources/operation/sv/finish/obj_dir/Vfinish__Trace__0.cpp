...
void Vfinish___024root__trace_chg_0_sub_0(Vfinish___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vfinish___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinish___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vfinish___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vfinish___024root__trace_chg_0_sub_0(Vfinish___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinish__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinish___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vfinish___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinish___024root__trace_cleanup\n"); );
    // Init
    Vfinish___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vfinish___024root*>(voidSelf);
    Vfinish__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
