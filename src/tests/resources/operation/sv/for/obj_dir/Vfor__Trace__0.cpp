...
void Vfor___024root__trace_chg_0_sub_0(Vfor___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vfor___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfor___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vfor___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vfor___024root__trace_chg_0_sub_0(Vfor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfor___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    bufp->chgCData(oldp+4,(vlSelf->Foo__DOT__unnamedblk1__DOT__i),8);
}

void Vfor___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfor___024root__trace_cleanup\n"); );
    // Init
    Vfor___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vfor___024root*>(voidSelf);
    Vfor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
