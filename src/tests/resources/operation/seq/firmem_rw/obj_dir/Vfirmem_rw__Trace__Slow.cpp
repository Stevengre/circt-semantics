...
void Vfirmem_rw::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addInitCb(&traceInit, __VlSymsp);
    traceRegister(tfp->spTrace());
}

void Vfirmem_rw::traceInit(void* userp, VerilatedVcd* tracep, uint32_t code) {
    // Callback from tracep->open()
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    ...
    tracep->scopeEscape(' ');
    Vfirmem_rw::traceInitTop(vlSymsp, tracep);
    tracep->scopeEscape('.');
}
...
void Vfirmem_rw::traceInitTop(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
...
void Vfirmem_rw::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    Vfirmem_rw* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->declBus(c+16,"rw_out", false,-1, 7,0);
        ...
        tracep->declBus(c+16,"Foo rw_out", false,-1, 7,0);
        ...
        tracep->declBus(c+10,"Foo memory_ext RW0_addr", false,-1, 1,0);
        tracep->declBit(c+14,"Foo memory_ext RW0_en", false,-1);
        tracep->declBit(c+5,"Foo memory_ext RW0_clk", false,-1);
        tracep->declBit(c+11,"Foo memory_ext RW0_wmode", false,-1);
        tracep->declBus(c+7,"Foo memory_ext RW0_wdata", false,-1, 7,0);
        tracep->declBus(c+16,"Foo memory_ext RW0_rdata", false,-1, 7,0);
...
void Vfirmem_rw::traceRegister(VerilatedVcd* tracep) {
    // Body
    {
...
void Vfirmem_rw::traceFullTop0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    Vfirmem_rw* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
...
void Vfirmem_rw::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    Vfirmem_rw* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+16,(vlTOPp->rw_out),8);
    }
}
