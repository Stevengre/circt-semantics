...
VL_INLINE_OPT void Vfirmem_rw___024root___ico_sequent__TOP__0(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___ico_sequent__TOP__0\n"); );
    // Body
    vlSelf->read_out = ((IData)(vlSelf->enable_r) ? 
                        vlSelf->Foo__DOT__memory_ext__DOT__Memory
                        [vlSelf->addr_r] : 0U);
    vlSelf->rw_out = (((~ (IData)(vlSelf->mode)) & (IData)(vlSelf->enable_rw))
                       ? vlSelf->Foo__DOT__memory_ext__DOT__Memory
                      [vlSelf->addr_rw] : 0U);
}

void Vfirmem_rw___024root___eval_ico(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_ico\n"); );
    // Body
    if ((1ULL & vlSelf->__VicoTriggered.word(0U))) {
        Vfirmem_rw___024root___ico_sequent__TOP__0(vlSelf);
    }
}

void Vfirmem_rw___024root___eval_triggers__ico(Vfirmem_rw___024root* vlSelf);

bool Vfirmem_rw___024root___eval_phase__ico(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_phase__ico\n"); );
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vfirmem_rw___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelf->__VicoTriggered.any();
    if (__VicoExecute) {
        Vfirmem_rw___024root___eval_ico(vlSelf);
    }
    return (__VicoExecute);
}

void Vfirmem_rw___024root___eval_act(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_act\n"); );
}

VL_INLINE_OPT void Vfirmem_rw___024root___nba_sequent__TOP__0(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___nba_sequent__TOP__0\n"); );
    // Init
    ...
    __Vdlyvset__Foo__DOT__memory_ext__DOT__Memory__v1 = 0;
    // Body
    ...
    if (((IData)(vlSelf->enable_rw) & (IData)(vlSelf->mode))) {
...
void Vfirmem_rw___024root___eval_nba(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_nba\n"); );
    // Body
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vfirmem_rw___024root___nba_sequent__TOP__0(vlSelf);
...
bool Vfirmem_rw___024root___eval_phase__act(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_phase__act\n"); );
    // Init
    VlTriggerVec<1> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    Vfirmem_rw___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        Vfirmem_rw___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool Vfirmem_rw___024root___eval_phase__nba(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_phase__nba\n"); );
    // Init
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = vlSelf->__VnbaTriggered.any();
    if (__VnbaExecute) {
        Vfirmem_rw___024root___eval_nba(vlSelf);
...
#endif  // VL_DEBUG
#ifdef VL_DEBUG
VL_ATTR_COLD void Vfirmem_rw___024root___dump_triggers__nba(Vfirmem_rw___024root* vlSelf);
#endif  // VL_DEBUG
#ifdef VL_DEBUG
...
void Vfirmem_rw___024root___eval(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval\n"); );
    // Init
...
#endif
            VL_FATAL_MT("seq/firmem_rw/firmem_rw.sv", 89, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vfirmem_rw___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
...
#ifdef VL_DEBUG
            Vfirmem_rw___024root___dump_triggers__nba(vlSelf);
#endif
            VL_FATAL_MT("seq/firmem_rw/firmem_rw.sv", 89, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("seq/firmem_rw/firmem_rw.sv", 89, "", "Active region did not converge.");
            }
            vlSelf->__VactIterCount = ((IData)(1U) 
                                       + vlSelf->__VactIterCount);
            vlSelf->__VactContinue = 0U;
            if (Vfirmem_rw___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vfirmem_rw___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vfirmem_rw___024root___eval_debug_assertions(Vfirmem_rw___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root___eval_debug_assertions\n"); );
    // Body
