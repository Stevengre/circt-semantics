...
void Vfirmem_rw___024root__trace_chg_0_sub_0(Vfirmem_rw___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vfirmem_rw___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vfirmem_rw___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vfirmem_rw___024root__trace_chg_0_sub_0(Vfirmem_rw___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    bufp->chgCData(oldp+15,(vlSelf->rw_out),8);
}

void Vfirmem_rw___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfirmem_rw___024root__trace_cleanup\n"); );
    // Init
    Vfirmem_rw___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vfirmem_rw___024root*>(voidSelf);
    Vfirmem_rw__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
