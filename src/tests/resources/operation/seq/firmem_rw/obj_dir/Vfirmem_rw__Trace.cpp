...
void Vfirmem_rw::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vfirmem_rw::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    Vfirmem_rw* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vfirmem_rw::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vfirmem_rw__Syms* __restrict vlSymsp = static_cast<Vfirmem_rw__Syms*>(userp);
    Vfirmem_rw* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
