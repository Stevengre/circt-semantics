...
void Vfrom_clock___024root__trace_chg_0_sub_0(Vfrom_clock___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vfrom_clock___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfrom_clock___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vfrom_clock___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vfrom_clock___024root__trace_chg_0_sub_0(Vfrom_clock___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfrom_clock__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfrom_clock___024root__trace_chg_0_sub_0\n"); );
    // Init
...
void Vfrom_clock___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfrom_clock___024root__trace_cleanup\n"); );
    // Init
    Vfrom_clock___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vfrom_clock___024root*>(voidSelf);
    Vfrom_clock__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
