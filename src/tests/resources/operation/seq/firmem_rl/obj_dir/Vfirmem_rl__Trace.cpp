...
void Vfirmem_rl::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vfirmem_rl::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rl__Syms*>(userp);
    Vfirmem_rl* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vfirmem_rl::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vfirmem_rl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rl__Syms*>(userp);
    Vfirmem_rl* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
