"builtin.module"() ({
  "hw.module"() ({
    ^bb0(%clk: !seq.clock, %data_in_w: i8, %data_in_rw : i8, %addr_r : i2, %addr_w : i2, %addr_rw : i2, %mode : i1, %enable_r : i1,%enable_w : i1, %enable_rw : i1):
      ...
      %read_write_data = "seq.firmem.read_write_port"(%mem, %addr_rw, %clk, %enable_rw, %data_in_rw, %mode) <{operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 1, 0>}> : (!seq.firmem<4 x 8>, i2, !seq.clock, i1, i8, i1) -> i8

      "hw.output"(%read_data, %read_write_data) : (i8, i8) -> ()
  }) {module_type = !hw.modty<input clk : !seq.clock, input data_in_w : i8,input data_in_rw : i8,input addr_r : i2,input addr_w : i2,input addr_rw : i2,input mode : i1,input enable_r : i1,input enable_w : i1,input enable_rw : i1, output read_out : i8, output rw_out : i8>, sym_name = "Foo", parameters = []} : () -> ()
}) : () -> ()
