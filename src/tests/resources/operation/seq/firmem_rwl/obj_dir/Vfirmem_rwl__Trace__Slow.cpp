...
void Vfirmem_rwl::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addInitCb(&traceInit, __VlSymsp);
    traceRegister(tfp->spTrace());
}

void Vfirmem_rwl::traceInit(void* userp, VerilatedVcd* tracep, uint32_t code) {
    ...
    tracep->scopeEscape(' ');
    Vfirmem_rwl::traceInitTop(vlSymsp, tracep);
    tracep->scopeEscape('.');
}
...
void Vfirmem_rwl::traceInitTop(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rwl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rwl__Syms*>(userp);
...
void Vfirmem_rwl::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rwl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rwl__Syms*>(userp);
    Vfirmem_rwl* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vfirmem_rwl::traceRegister(VerilatedVcd* tracep) {
    // Body
    {
...
void Vfirmem_rwl::traceFullTop0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rwl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rwl__Syms*>(userp);
    Vfirmem_rwl* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
...
void Vfirmem_rwl::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    Vfirmem_rwl__Syms* __restrict vlSymsp = static_cast<Vfirmem_rwl__Syms*>(userp);
    Vfirmem_rwl* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
