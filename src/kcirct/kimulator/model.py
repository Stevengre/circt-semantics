...
class KimulatorModel:
    ...
    def __init__(
        ...
        children: Optional[dict[str, KimulatorModel]] = None,
        context: Optional[KimulatorContext] = None,
    ):
        if signals is None:
            signals = {}
        if children is None:
    ...
    def eval(self):
        ...
        if self.context.state is None:
            ...
            ctrl_kore = self.context.kprint._expression_kast(
        ...
        for ob_out_module in ob_out_modules:
            ...
            for module_output in module_outputs:
                ...
                output_value = int(
                    flatten_label('TV(_,_)_CIRCT-SYNTAX-CORE_TypeValue_Type_Value', output_value[1])[1].token
                )
