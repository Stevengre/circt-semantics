...
This section outlines {\ourStudy}'s academic context, focusing on our formalization target, CIRCT, and our chosen formal framework, {\K}. Initially, it delves into the complexities and challenges in CIRCT, reviewing relevant formal semantics efforts that have tackled comparable challenges. It then shifts to the introduction of the {\K} framework, along with its application in established formal semantics. This exploration guides us in identifying the opportunities and challenges in formalizing CIRCT. An overview of how {\ourStudy} addresses these challenges is presented in Section~\ref{sec:overview}.
