...
def exec_parse(
    ...
    **kwargs: Any,
    ...
    proc_res = kirct.parse(input_file, input=kast_input, output=kast_output)
...
def create_argument_parser() -> ArgumentParser:
    ...
    # Parse
    parse_subparser = command_parser.add_parser('parse', help='Parse a generic .mlir file, then return kore. Use `circt-opt --mlir-print-op-generic` to obtain one.', parents=[shared_args])
